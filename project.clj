...
(defproject clj-micro-dev "0.0.1-SNAPSHOT"
  ...
  :profiles {:dev {:aliases {"run-dev" ["trampoline" "run" "-m" "clj-micro-dev.server/run-dev"]}
                   :dependencies [[io.pedestal/pedestal.service-tools "0.5.11-beta-1"]]}
             :uberjar {:aot [clj-micro-dev.server]}}
  :main ^{:skip-aot true} clj-micro-dev.server)
